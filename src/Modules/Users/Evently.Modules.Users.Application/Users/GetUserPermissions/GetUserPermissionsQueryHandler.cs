    ...
    : IQueryHandler<GetUserPermissionsQuery, PermissionsResponse>
{
    ...
    {
        await using DbConnection connection = await dbConnectionFactory
            .OpenConnectionAsync();
        ...
        List<UserPermission> permissions = (await connection
            .QueryAsync<UserPermission>(sql, request)).AsList();
